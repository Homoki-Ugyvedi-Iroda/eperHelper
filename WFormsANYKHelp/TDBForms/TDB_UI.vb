Public Class TDB_UI
    ...
    Private Sub TDB_UI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Me.RogzitoTableAdapter.Fill(Me.TorzsAdatbazisDataSet.Ugyvedi_iroda_rogzito)
        Me.ToolStrip_Üi.Visible = False
    ...
    Private Sub btnBezaresMent_Click(sender As Object, e As EventArgs) Handles btnBezaresMent.Click
        ...
        If IDStr = "-1" Then
            Dim lastrow As DataRow() = Me.TorzsAdatbazisDataSet.Ugyvedi_iroda_rogzito.Select("ID=Max(ID)")
            Dim idint As Integer = lastrow(0)("ID")
            idint += 1
            IDStr = CStr(idint)
        End If

        Dim TeljesNevStr As String = Me.Ügyvédi_iroda_neveTextBox.Text
    ...
    Private Sub IrszámLeft_Igazitas(sender As Object, e As EventArgs) Handles Állandólakcím_IrányítószámComboBox.Validating, Levelezési_címe_IrányítószámComboBox.Validating
        ...
        Try
            ...
            'senderbox.SelectedValue = IrszamStr
            'senderbox.Text = IrszamInt.ToString
        ...
        End If
    End Sub
    Private Sub Település_neveComboBox_Leave(sender As Object, e As EventArgs) Handles Állandólakcím_Település_neveComboBox.Validating, Levelezési_címe_Település_neveComboBox.Validating
        Dim senderbox As ComboBox = CType(sender, ComboBox)
        'If senderbox.Items.Count = 0 Or Állandólakcím_Település_neveComboBox.Items.Count = 0 Or Levelezési_címe_Település_neveComboBox.Items.Count = 0 Then Exit Sub
