Public Class TDB_ESZ
    Private Sub TDB_ESZ_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Me.RogzitoTableAdapter.Fill(Me.TorzsAdatbazisDataSet.Egyeb_szervezet_rogzito)
        Me.ToolStrip_ESZ.Visible = False
    ...
    Private Sub btnBezaresMent_Click(sender As Object, e As EventArgs) Handles btnBezaresMent.Click
        ...
        If IDStr = "-1" Then
            Dim lastrow As DataRow() = Me.TorzsAdatbazisDataSet.Egyeb_szervezet_rogzito.Select("ID=Max(ID)")
    ...
    Private Sub btnKeres_Click(sender As Object, e As EventArgs) Handles btnKeres.Click
        Dim IDtoGo As Integer = GetResultsfromPersonDT(TorzsAdatbazisDataSet.Egyeb_szervezet_rogzito, tbKereso.Text)
    ...
    Private Sub AddCustomSource()
        ...
        For Each drow In Me.TorzsAdatbazisDataSet.Egyeb_szervezet_rogzito
            If drow.Szervezet_megnevezése IsNot Nothing AndAlso Not IsDBNull(drow.Szervezet_megnevezése) AndAlso Not String.IsNullOrWhiteSpace(drow.Szervezet_megnevezése) Then fullnevlist.Add(drow.Szervezet_megnevezése)
        Next
