Public Class TDB_EU
    ...
    Private Sub TDB_EU_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.RogzitoTableAdapter.Fill(Me.TorzsAdatbazisDataSet.Egyeni_ugyvedi_rogzito)
        ...
        Me.ToolStrip_Ügyvéd.Visible = False
    ...
    Private Sub btnBezaresMent_Click(sender As Object, e As EventArgs) Handles btnBezaresMent.Click
        ...
        If IDStr = "-1" Then
            Dim lastrow As DataRow() = Me.TorzsAdatbazisDataSet.Egyeni_ugyvedi_rogzito.Select("ID=Max(ID)")
