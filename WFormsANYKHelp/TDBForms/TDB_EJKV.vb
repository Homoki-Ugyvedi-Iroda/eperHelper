Public Class TDB_EJKV
    ...
    Private Sub TDB_EJKV_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.RogzitoTableAdapter.Fill(Me.TorzsAdatbazisDataSet.Egyeb_jogi_kvo_rogzito)
    ...
    Private Sub btnBezaresMent_Click(sender As Object, e As EventArgs) Handles btnBezaresMent.Click
        ...
        If IDStr = "-1" Then
            Dim lastrow As DataRow() = Me.TorzsAdatbazisDataSet.Egyeb_jogi_kvo_rogzito.Select("ID=Max(ID)")
